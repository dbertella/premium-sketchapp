		...
		return (
			React.createElement("section", null, 
				React.createElement("aside", null, 
					React.createElement("section", {class: "category"}, 
						React.createElement("ul", null,  this.props.categories.map(function (cat) {
							
								return React.createElement("li", null,  cat );
						}, this))
					)
				), 
				React.createElement("section", null,  this.props.freebies.map(function (freebie) {
...
React.render(React.createElement(Main, {frebies:  data }), document.getElementById('main'));
